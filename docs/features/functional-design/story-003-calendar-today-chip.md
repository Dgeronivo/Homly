...
- [ ] Кнопка/чіп "Сьогодні" видима на екрані календаря незалежно від переглянутого місяця
- [ ] Клік повертає на поточний місяць і обирає сьогоднішній день одним переходом
- [ ] `CalendarUiState` без нових полів
- [ ] `make rebuild` — зелений
- [ ] `make test` — новий/оновлений `CalendarViewModelTest` зелений
